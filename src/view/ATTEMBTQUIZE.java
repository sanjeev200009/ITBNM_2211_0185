 ...
 * @author user
 */
public class ATTEMBTQUIZE extends javax.swing.JFrame {

    /**
     * Creates new form ATTEMBTQUIZE
     */
    public ATTEMBTQUIZE() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 0, 1740, 90));
        ...
        jTextArea1.setText("Welcome to the General Knowledge Quiz!\n\nWe are excited to have you participate in this engaging and informative quiz. \nThe purpose of this quiz is to test your knowledge across a variety of topics, ranging from science and history to literature and geography. \nIt's a great way to challenge yourself, learn new facts, and have fun.\n\nQuiz Instructions: Clear instructions on how to take the quiz, including how to select answers, time limits, and how to submit the quiz.\nRules and Guidelines: Any rules or guidelines, such as no external help, no use of textbooks or the internet, etc.\nScoring Information: Explain how the scoring works (e.g., each correct answer is worth one point).\n\nBefore you begin, please take a moment to review the instructions and guidelines. Once you're ready, click the 'Start Quiz' button to begin. Good luck, and enjoy the quiz!");
        jScrollPane1.setViewportView(jTextArea1);

        jLabel2.setFont(new java.awt.Font("Times New Roman", 2, 24)); // NOI18N
        jLabel2.setText("Question: What is the chemical symbol for the element gold? Description: This question tests knowledge of the periodic table and basic chemistry.:");

        jLabel3.setFont(new java.awt.Font("Times New Roman", 2, 24)); // NOI18N
        jLabel3.setText("Question: Which ancient civilization built the Machu Picchu complex in Peru? Description: This question evaluates knowledge of world history and ancient civilizations.");

        jLabel4.setFont(new java.awt.Font("Times New Roman", 2, 24)); // NOI18N
        jLabel4.setText("Question: Who developed the theory of general relativity? Description: This question assesses understanding of significant scientific contributions and historical figures ");

        jLabel5.setFont(new java.awt.Font("Times New Roman", 2, 24)); // NOI18N
        jLabel5.setText("Question: What is the largest organ in the human body? Description: This question examines understanding of human anatomy and physiology.");

        jLabel6.setFont(new java.awt.Font("Times New Roman", 2, 24)); // NOI18N
        jLabel6.setText("Question: In which year did the Titanic sink? Description: This question checks knowledge of historical events.");
        ...
        jLabel9.setText("SELECT THE ANSWER");

        jLabel20.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel20.setText("SELECT THE ANSWER");

        jLabel21.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel21.setText("SELECT THE ANSWER");

        jLabel22.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel22.setText("SELECT THE ANSWER");

        jLabel23.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel23.setText("SELECT THE ANSWER");

        jLabel24.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/icons8-timer-100.png"))); // NOI18N

        jLabel25.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel25.setText("TIMER");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " Au", " Ag", " Pb", " Fe" }));

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Isaac Newton", "Albert Einstein", "Galileo Galilei", "Nikola Tesla" }));

        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Aztec", "Maya", "Inca", "Olmec" }));

        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Liver", "Brain", "Skin", "Heart" }));

        jComboBox5.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1910", " 1912", " 1914", " 1916" }));

        jButton1.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jButton1.setText("FINISHED ATTEMT");
        ...
        jLabel26.setText("PLEASE ENTER YOUR NAME");
    ...
    String q3 =jComboBox3.getSelectedItem().toString();
    String q4 = jComboBox4.getSelectedItem().toString();
    String q5 =jComboBox5.getSelectedItem().toString();
    
    ADDMARKSCONTROLLER.QUIZ(Name, q1, q2, q3, q4, q5);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ATTEMBTQUIZE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ATTEMBTQUIZE().setVisible(true);
            }
        });
    }
