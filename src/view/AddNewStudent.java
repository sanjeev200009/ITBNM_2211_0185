...
public class AddNewStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        MUSLIM = new javax.swing.JCheckBox();
        CHIRSTIAN = new javax.swing.JCheckBox();
        BUDDHISM = new javax.swing.JCheckBox();
        STUDENTNAME = new javax.swing.JTextField();
        STUDENADDRES = new javax.swing.JTextField();
        ...
        jButton9.setText("BACK TO ADMIN DASHBORD");
        ...
        getContentPane().add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 0, -1, 90));
        ...
        jLabel10.setText("STUDENT RELIGION ");

        jLabel11.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel11.setText("ADDMISSION DATE");
        ...
        HINDU.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        HINDU.setText("HINDU");

        MUSLIM.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        ...
        CHIRSTIAN.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        CHIRSTIAN.setText("CHIRSTIAN");
        CHIRSTIAN.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CHIRSTIANActionPerformed(evt);
            }
        });

        BUDDHISM.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        BUDDHISM.setText("BUDDHISM");
        ...
        jButton7.setBackground(new java.awt.Color(23, 119, 227));
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(STUDENTNAME, javax.swing.GroupLayout.DEFAULT_SIZE, 307, Short.MAX_VALUE)
                                .addComponent(STUDENADDRES)
                                .addComponent(STUDENTNUMBER))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(maleRBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 129, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(107, 107, 107)
                                .addComponent(femaleRBtn))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(CHIRSTIAN)
                                    .addComponent(HINDU))
                                .addGap(107, 107, 107)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(BUDDHISM)
                                    .addComponent(MUSLIM)))
                            .addComponent(datePicker, javax.swing.GroupLayout.PREFERRED_SIZE, 307, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(204, 204, 204)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(STUDENADDRES, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(48, 48, 48)
                        .addComponent(jLabel4)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(40, 40, 40)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(maleRBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(femaleRBtn))
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(49, 49, 49)
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 70, -1, 1025));
...
if (BUDDHISM.isSelected()) {
    religion = "BUDDHISM";
} else if (CHIRSTIAN.isSelected()) {
    religion = "CHRISTIAN";
} else if (HINDU.isSelected()) {
    religion = "HINDU";
} else if (MUSLIM.isSelected()) {
    religion = "MUSLIM";
} else {
    // Handle case where no religion is selected
    JOptionPane.showMessageDialog(null, "Please select a religion", "Error", JOptionPane.ERROR_MESSAGE);
    return; // Exit method without proceeding
}

// Assuming datePicker is a component that provides date selection
...
// Get other student details from text fields or input components
String studentName = STUDENTNAME.getText();
String studentAddress = STUDENADDRES.getText();
String studentContactNumber = STUDENTNUMBER.getText();

// Call the controller method to add student
//ADDNewStudentController.addStudent(studentName, studentAddress, gender, religion, studentContactNumber, sqlDate.toString());

 ADDMARKSCONTROLLER.STUDNET(studentName, studentAddress, gender, religion, studentContactNumber, sqlDate.toString());
...
clearField();        
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
            new view.DisplayaddedStudent() .setVisible(true);
        dispose();        // TODO add your handling code here:
    }//GEN-LAST:event_jButton7ActionPerformed

    private void CHIRSTIANActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CHIRSTIANActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_CHIRSTIANActionPerformed
    ...
    private javax.swing.JCheckBox BUDDHISM;
    private javax.swing.JCheckBox CHIRSTIAN;
    ...
    private javax.swing.JCheckBox MUSLIM;
    private javax.swing.JTextField STUDENADDRES;
